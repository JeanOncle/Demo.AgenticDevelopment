...
description: Produces technical designs and architecture decisions for the highest-priority DEMO Story ready for development, without editing application code.
---
...
- Select and refine only the highest-priority `DEMO` Story in `Ready for development`; when priorities tie, select the newest created Story.
...
- If no material blocker exists, add the technical design and a concise ADR, then transition the Story to `Refined`.
